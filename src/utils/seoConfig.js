...
export const SITE_NAME = "ADFincas - Administración de Fincas & Servicios Inmobiliarios";
...
export const SEO_DATA = {
  home: {
    title: "ADFincas - Administración de Fincas Profesional",
  ...
  legal: {
    title: "Información Legal - ADFincas",
    description: "Información legal y términos de servicio de ADFincas.",
    keywords: "información legal, términos de servicio, condiciones de uso",
    ogType: "website",
    canonical: `${SITE_URL}/legal`,
  },
  privacy: {
    title: "Política de Privacidad - ADFincas",
    description: "Política de privacidad y protección de datos de ADFincas.",
...
export const ORGANIZATION_SCHEMA = {
  ...
  "image": SITE_IMAGE,
  "sameAs": [
    "https://www.facebook.com/ADFincas",
    "https://www.instagram.com/ADFincas",
    "https://www.linkedin.com/company/ADFincas",
  ],
  "contactPoint": {
    "@type": "ContactPoint",
